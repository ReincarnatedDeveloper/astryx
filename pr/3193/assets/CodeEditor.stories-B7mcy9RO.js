import{a1 as e,ah as m}from"./iframe-D7J5C_JU.js";import{C as d}from"./CodeEditor-DP2OaAl4.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-CIrpI2ZW.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
